            ...
            <div class="fl login-left">
                ...
                <div class="fl panel">
                	<p class="login-rows mt30">
                    	<input type="text" name="account" id="loginName" class="login-input login-name easyui-validatebox" placeholder="用户名"  validType="Length[4,22]" data-options="required:true" value="<shiro:principal/>"/>
                    </p>
                    <p class="login-rows mt30">
